...
if (isset($_POST['pbooking'])) {
  try {
    ...
    if(isset($_POST['cindate'])) {
      ...
      // Handle the case when 'cindate' is not set
      $cindate = null; // or any default value you prefer
  }
  
  if(isset($_POST['coutdate'])) {
      $coutdate = $_POST['coutdate'];
  } else {
      // Handle the case when 'coutdate' is not set
      $coutdate = null; // or any default value you prefer
  }
