                ...
                <div class="row">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><?php echo isset($_GET['r_type']) ? $_GET['r_type'] : ''; ?></li>
                        </ul>
                    </div>
                </div>
            </div>
            <form action="report_gen.php?r_type=<?php echo isset($_GET['r_type']) ? $_GET['r_type'] : ''; ?>" method="post">
                                ...
                                <tbody>
                                    ...
                                    if (isset($_GET['r_type'])) {
                                        ...
                                        if (is_dir($dir_path)) {
                                            ...
                                            echo "Directory doesn't exist or cannot be read.";
                                        }
                                    } else {
